			...
			<ul class="topiclist">
                ...
                <div class="custom-cat-header-left">
                    ...
                    <div class="custom-cat-header-right"></div>
						<dt><?php if ($_forumrow_val['S_IS_CAT']) {  ?><div style="padding-left: 20px; margin-top: 8px;"><a href="<?php echo $_forumrow_val['U_VIEWFORUM']; ?>"><?php echo $_forumrow_val['FORUM_NAME']; ?></a><?php } else { ?><div style="padding-left: 20px; margin-top: 8px; font-weight: bold; font-family: Tahoma, Geneva, sans-serif; text-shadow: 2px 2px 2px #0b2534;"><?php echo ((isset($this->_rootref['L_FORUM'])) ? $this->_rootref['L_FORUM'] : ((isset($user->lang['FORUM'])) ? $user->lang['FORUM'] : '{ FORUM }')); ?></div><?php } ?></div></dt>
					</dl>
