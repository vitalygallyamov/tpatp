...
$tinybrowser['path']['image'] = '/userfiles/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/userfiles/'; // Media files location
$tinybrowser['path']['file']  = '/userfiles/'; // Other files location
